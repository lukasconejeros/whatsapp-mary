...
export default function ConversationView({ conv }: { conv: Conversation }) {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', fontFamily:'inherit' }}>
      ...
      <form onSubmit={send} style={{ display:'flex',flexDirection:'column',gap:6,paddingTop:8,paddingLeft:10,paddingRight:10,paddingBottom:'calc(28px + env(safe-area-inset-bottom))',background:'#F0F2F5',borderTop:'1px solid #E9EDEF',flexShrink:0 }}>
        {sendError && (
