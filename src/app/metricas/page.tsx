...
const CH_DOT: Record<string, string> = { whatsapp: '#22C55E', instagram: '#A855F7', messenger: '#00A884', tiktok: '#000000', unknown: '#9CA3AF' }
        ...
        <div className="flex-1 overflow-y-auto" style={{ padding: '20px 24px' }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
              <KpiCard label="Total leads" value={dl?.totalLeads as number ?? '—'} sub="en base de datos" icon={Users} loading={loadingDl} accent="#00A884" />
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
              ...
              <KpiCard label="Activas (30d)" value={cw?.total30d ?? '—'} sub="actividad reciente" icon={TrendingUp} loading={loadingCw} accent="#00A884" />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <div style={{ background: 'var(--color-surface)', borderRadius: 'var(--radius-xl)', border: '1px solid var(--color-border)', padding: '16px 18px' }}>
              ...
              {cw && <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[['Bot activo (IA)', cw.byState.activo, '#00A884'], ['Derivado a humano', cw.byState.derivado, '#8B5CF6'], ['Resueltos', cw.byState.resuelto, '#9CA3AF']].map(([label, count, color]) => (
