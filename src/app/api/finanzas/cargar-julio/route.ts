...
// Carga ÚNICA de la cartola de MercadoPago de julio 2026 (30-jun a 10-jul), protegida
// con token. Idempotente (dedup por mp_id). TEMPORAL: quitar tras cargar.
const TOKEN = "arteluk-carga-jul-7k2";
...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({ ok: true, ingresosNuevos, costosNuevos, duplicados, omitidos: r.omitidos, totalIngresos: r.totalIngresos, totalCostos: r.totalCostos });
}
