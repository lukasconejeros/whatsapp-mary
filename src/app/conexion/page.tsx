  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: '#EFF6FF' }}>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        <header className="flex items-center shrink-0" style={{ height: 56, padding: '0 28px', background: '#fff', borderBottom: '1px solid #BFDBFE' }}>
          <h1 style={{ fontSize: 15, fontWeight: 700, color: '#1E3A5F', letterSpacing: '-0.01em' }}>Conexión</h1>
        </header>
        ...
        <div className="flex-1 overflow-y-auto" style={{ padding: '28px' }}>
          <div style={{ maxWidth: 460, margin: '0 auto' }}>
            ...
            {/* Tarjeta principal */}
            <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #BFDBFE', boxShadow: '0 1px 3px rgba(30,58,95,0.06)', padding: '28px', textAlign: 'center' }}>
              {connected ? (
                <>
                  <p style={{ fontSize: 14, color: '#1E3A5F', fontWeight: 600, marginBottom: 6 }}>WhatsApp vinculado y funcionando ✅</p>
                ...
                <>
                  <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #DBEAFE', padding: 12, display: 'inline-block', marginBottom: 18 }}>
                ...
                <div style={{ padding: '30px 0' }}>
                  <div style={{ width: 26, height: 26, margin: '0 auto 12px', border: '3px solid #DBEAFE', borderTopColor: '#2563EB', borderRadius: '50%', animation: 'spin 0.7s linear infinite' }} />
              ...
              <button onClick={regenerar} disabled={regenerating}
                ...
                style={{ width: '100%', marginTop: 16, height: 38, borderRadius: 8, border: '1px solid #BFDBFE',
                  background: connected ? '#fff' : '#2563EB', color: connected ? '#2563EB' : '#fff',
