  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: '#FFF4FA' }}>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <form onSubmit={e => { e.preventDefault(); enviar(texto) }} style={{ display: 'flex', gap: 8, padding: '12px 16px', borderTop: '1px solid #FAD1E5', background: '#FFFFFF', maxWidth: 720, width: '100%', margin: '0 auto', flexShrink: 0 }}>
          ...
          <input value={texto} onChange={e => setTexto(e.target.value)} placeholder="Escribe aquí…" style={{ flex: 1, borderRadius: 12, border: '1px solid #FAD1E5', padding: '0 14px', fontSize: 13, outline: 'none' }} />
